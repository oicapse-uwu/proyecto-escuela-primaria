...
interface InstitucionFormProps {
    ...
    onSubmit: (data: InstitucionDTO) => Promise<void>;
    onCancel: () => void;
    isLoading?: boolean;
}
...
const InstitucionForm: React.FC<InstitucionFormProps> = ({ 
    ...
    const [formData, setFormData] = useState<InstitucionDTO>({
        nombre: '',
        codModular: '',
        tipoGestion: 'Pública',
        resolucionCreacion: '',
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        if (formData.resolucionCreacion && formData.resolucionCreacion.trim() !== '' && !RESOLUCION_REGEX.test(formData.resolucionCreacion)) {
            setResolucionTouched(true);
                                ...
                                <div className="md:col-span-2 relative">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            onChange={handleChange}
                                            onFocus={() => {
                                                if (!formData.resolucionCreacion || formData.resolucionCreacion.trim() === '') {
